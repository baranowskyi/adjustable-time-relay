...
Данный проект разрабатывался для работы со звуковыми отпугивателями птиц типо "Коршун-8". В устройстве есть таймер включения\выключения, но в нём нет возможности задать определённое время включения и выключения. Поэтому было принято решение вынести эту логику в отдельное устройство, которое будет само включать и выключать отпугиватель, когда это нужно пользователю.
